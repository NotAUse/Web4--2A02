    ...
    if (!empty($nom) && strlen($nom) <= 255) {
        try {
            ...
            if ($stmt->execute()) {
                ...
                $error = "Une erreur inconnue est survenue lors de l'ajout de la catégorie.";
            }
        ...
        $error = "Le nom de la catégorie est invalide. Il doit avoir entre 1 et 255 caractères.";
    }
}
?>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <form method="POST" action="add_categorie.php">
                            ...
                            <input class="form-control form-control-user" type="text" id="nom" name="nom" maxlength="255" required>
                            <br>
