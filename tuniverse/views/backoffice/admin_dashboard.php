                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    ...
                    <span class="profile-username">
                      ...
                      <span class="fw-bold">Oussema</span>
                    </span>
                  </a>
...
<body>
    <div class="admin-container">
        ...
        <!-- Logout Button -->
        <a href="../frontoffice/logout.php" class="logout-button">Logout</a>
        ...
        <div class="filters">
            <div>
                ...
                <select name="role" id="roleFilter">
                    ...
                    <option value="user">Employers</option>
                </select>
            </div>
            <div>
                ...
                <?php foreach ($users as $user): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="admin_dashboard.php?action=delete&id=<?php echo $user['id']; ?>" class="delete-button" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
                            ...
                            users.forEach(user => {
                                ...
                                row.innerHTML = `
                                    ...
                                    <td>
                                        ...
                                        <a href="admin_dashboard.php?action=delete&id=${user.id}" class="delete-button" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                                    </td>
                                `;
