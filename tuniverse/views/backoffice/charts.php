...
<html lang="en">
  ...
  <body>
      ...
      <div class="sidebar" data-background-color="dark">
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="/tun2/views/index.html" class="logo">
              <img
                src="/tun2/views/backoffice/img/kaiadmin/logo_light.svg"
                alt="navbar brand"
                class="navbar-brand"
                height="20"
              />
      ...
      <div class="main-panel">
        <div class="main-header">
          <div class="main-header-logo">
            ...
            <div class="logo-header" data-background-color="dark">
              <a href="/tun2/views/index.html" class="logo">
                <img
                  src="../backoffice/img/kaiadmin/logo_light.svg"
                  alt="navbar brand"
                  class="navbar-brand"
                  height="20"
                />
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="../backoffice/img/jm_denis.jpg"
                                alt="Img Profile"
                              />
                            </div>
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="/tun2/views/backoffice/img/chadengle.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="/tun2/views/backoffice/img/mlane.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="/tun2/views/backoffice/img/talha.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                      ...
                      <div class="notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="/tun2/views/backoffice/img/bg-404.jpeg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                    ...
                    <div class="dropdown-user-scroll scrollbar-outer">
                      <li>
                        <div class="user-box">
                          <div class="avatar-lg">
                            <img
                              src="../backoffice/img/profile.jpg"
                              alt="image profile"
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div class="container">
              <h1 class="my-2">Event Categories</h1>
              ...
              <script>
                ...
                document.addEventListener('DOMContentLoaded', () => {
                  ...
                  // Attach event listener and apply initial filter
                  categorySelect.addEventListener('change', filterEvents);
                  filterEvents(); // Initial call to show the correct events
              });
                  ...
                  echo '<div class="col-md-6">
                          <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <img src="'. htmlspecialchars($row['images']).'" alt="Images" style="width: 100px;"> 
      ...
      <div id="content" class="mb-4"></div>
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center pagination-lg">
              ...
              <li class="page-item" id="page-1"><a class="page-link" href="#" data-page="1">1</a></li>
              <li class="page-item" id="page-2"><a class="page-link" href="#" data-page="2">2</a></li>
              <li class="page-item" id="page-3"><a class="page-link" href="#" data-page="3">3</a></li>
                    ...
                    <form id="addEventForm" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="modal-body">
                        ...
                        <select name="category" class="form-control mb-2" id="category">
                          ...
                          <option value="Festival" class="event festival">Festival</option>
                          <option value="Musical" class="event music">Musical</option>
                          <option value="Concert" class="event concert">Concert</option>
                          <option value="Stand-up" class="event stand">Stand-up</option>
                        </select>
                        ...
                        <input type="file" name="images" id="images" accept="images/*">
              ...
              <div class="modal fade" id="deleteEventModal" tabindex="-1" aria-labelledby="deleteEventLabel" aria-hidden="true">
                <div class="modal-dialog">
                  ...
                  <form method="POST" style="display:inline;" id="deleteEventForm">
                      ...
                      <input type="hidden" name="id_event" value="123">
   ...
   <div class="container-fluid d-flex justify-content-between">
    ...
    <script>
      $(document).ready(function () {
        ...
        $('#addEventForm').submit(function (e) {
          e.preventDefault();
          $.ajax({
            url: '../../controllers/events.php', // Ensure the path matches your project structure
            type: 'POST',
    ...
    <script src="../backoffice/js/cntrl.js"></script>

    <!--   Core JS Files   -->
    <script src="/tun2/views/backoffice/js/core/jquery-3.7.1.min.js"></script>
    <script src="/tun2/views/backoffice/js/core/popper.min.js"></script>
    <script src="/tun2/views/backoffice/js/core/bootstrap.min.js"></script>
    <!-- Chart JS -->
    <script src="/tun2/views/backoffice/js/plugin/chart.js/chart.min.js"></script>
    <!-- jQuery Scrollbar -->
    <script src="/tun2/views/backoffice/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js"></script>
    <!-- Kaiadmin JS -->
    <script src="/tun2/views/backoffice/js/kaiadmin.min.js"></script>
    <!-- Kaiadmin DEMO methods, don't include it in your project! -->
    <script src="/tun2/views/backoffice/js/setting-demo2.js"></script>
    <script>
