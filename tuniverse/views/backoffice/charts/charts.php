        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div class="page-category">
              Here’s a list of exciting upcoming events across Tunisia. For more information, please visit the official websites.
            </div>
            <div class="row">
              <?php
                  ...
                  <div class="modal-content">
                    <form id="addEventForm">
                      ...
                      <div class="modal-body">
                        <input type="text" name="Nom" placeholder="Event Name" required class="form-control mb-2" />
                        <textarea name="description" placeholder="Description" required class="form-control mb-2"></textarea>
                        <input type="text" name="localisation" placeholder="Location" required class="form-control mb-2" />
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <form id="deleteEventForm">
                      ...
                      <div class="modal-body">
                        <input type="number" name="id_event" placeholder="Event ID" required class="form-control mb-2" />
                      </div>
                      <div class="modal-footer">
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
      ...
      $(document).ready(function () {
        ...
        $('#addEventForm').submit(function (e) {
          e.preventDefault();
          $.ajax({
            url: 'events.php', // Ensure the path matches your project structure
            type: 'POST',
