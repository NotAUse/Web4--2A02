...
<div class="form-background">
    <div class="container centered-form">
        ...
        <div class="card form-card shadow">
            <div class="card-body">
                <h4 class="card-title mb-4 text-center">Add Ingredient</h4>
                <form action="../../Controllers/add_ingredient.php" method="POST" onsubmit="return validateForm()">
                    <div class="mb-3">
                        <label for="nom" class="form-label">Ingredient Name</label>
                        <input type="text" class="form-control" id="nom" name="nom">
                        <small id="nameHelp" class="form-text text-danger" style="display:none;">Ingredient name cannot exceed 20 characters and must not contain special characters.</small>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="categorie" name="categorie">
                            ...
                            <option value="Sweets/Sugars">Sweets/Sugars</option>
...
<script>
    ...
    function validateForm() {
        const ingredientName = document.getElementById("nom");
        const unit = document.getElementById("unite");
        const category = document.getElementById("categorie");
        const nameHelp = document.getElementById("nameHelp");
        const specialCharRegex = /[^a-zA-Z ]/; // Allows only letters
        ...
        if (ingredientName.value.length > 20) {
            isValid = false;
            nameHelp.innerHTML = "Ingredient name cannot exceed 20 characters.";
            nameHelp.style.display = "block"; // Afficher le message d'erreur spécifique
        }
        // Vérification des caractères spéciaux
        else if (specialCharRegex.test(ingredientName.value)) {
            isValid = false;
            nameHelp.innerHTML = "Ingredient name must not contain special characters.";
            nameHelp.style.display = "block"; // Afficher le message d'erreur spécifique
        } else {
            nameHelp.style.display = "none"; // Cacher le message d'erreur si valide
            ingredientName.classList.remove("is-invalid");
        }
    }

    // Vérifier si l'unité est vide
    if (unit.value.trim() === "") {
        isValid = false;
    ...
    // Afficher un message global si un des champs est vide ou invalide
    if (!isValid) {
