    ...
    <div class="container centered-form">
        ...
        <div class="card form-card shadow">
            <div class="card-body">
                ...
                <form action="../../Model/add_ingredient.php" method="POST" onsubmit="return validateForm()">
                    <div class="mb-3">
...
<script>
    function validateForm() {
        ...
        // Check if the ingredient name length exceeds 20 characters
        if (ingredientName.value.length > 20) {
            nameHelp.innerHTML = "Ingredient name cannot exceed 20 characters and must not contain special characters.";
            nameHelp.style.display = "block"; // Show error message
            ingredientName.focus(); // Focus on the input field
            return false; // Prevent form submission
        }
        
        // Check for special characters
        if (specialCharRegex.test(ingredientName.value)) {
