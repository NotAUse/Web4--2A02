                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                      <h4 class="card-title">Ajouter un site culturel</h4>
                       <a href="../backoffice/addsite.php"
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        foreach ($list as $site) {?>
                            ...
                            <td>
                            <form action="deletesite.php" method="GET" style="display:inline;">
                    ...
                    <div id="map"></div>
                    <script>
                        mapboxgl.accessToken = 'pk.eyJ1IjoiYXlvdWJqZW1hbGkiLCJhIjoiY20zbW1rOGY1MTF1aTJscGV6MGlxbmF0ZiJ9.F-EzV87Y8esiLlUpBvr8AQ';
