        ...
        <div class="main-header">
          ...
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Liste des experiences culturelles</h3>
                        ...
                        foreach ($list as $experience) {?>
                            <tr>
                                ...
                                <form method="POST" action="updateexperience.php">
                                    ...
                                    <input type="hidden" value="<?php echo $experience['nom_site']; ?>" name="nom_site">
                                    <button type="submit" name="updateexperience" class="btn btn-primary">Update</button>
                                </form>
                                </td>
                                <td>
