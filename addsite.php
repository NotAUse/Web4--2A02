              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">Ajouter un site culturel</div>
                  </div>
                    <div class="card-body">
                      <div class="row">
                        <form id="addTravelOfferForm" action="" method="POST" enctype="multipart/form-data">
                          ...
                          <button type="submit" class="btn btn-primary btn-user btn-block" onClick="validerFormulaire()">Add site</button> 
                        </form>
                      </div>
                    </div>
                </div>
