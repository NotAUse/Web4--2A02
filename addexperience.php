...
if (isset($_POST['titre'], $_POST['descriptionE'], $_POST['dateE'] , $_POST['id_site'])) {
    if (!empty($_POST['titre']) && !empty($_POST['descriptionE']) && !empty($_POST['dateE']) && !empty($_POST['id_site'])) {
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="../backoffice/assets/img/jm_denis.jpg"
                                alt="Img Profile"
                              />
                            </div>
        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Ajouter une experience culturelle</h3>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">Ajouter une experience culturelle</div>
                  </div>
                    <div class="card-body">
                      <div class="row">
                        <form id="addExperienceForm" action="" method="POST">
                        <label for="id_site">Site:</label>
                        <select class="form-control form-control-user" name="id_site" id="id_site"required>
                            <option value=""> -- Choisir un site -- </option>
                            <?php
                            foreach ($sites as $site) {
                                echo "<option value='" . $site['id_site'] . "'>" . $site['nom'] . "</option>";
                            }
                            ?>
                        </select><br>
                        ...
                        <textarea class="form-control" id="descriptionE" rows="5" name="descriptionE">
                        </textarea>

                        <label for="dateE">Date d'ouverture de l'experience:</label><br>
                        <input class="form-control form-control-user" type="date" id="dateE" name="dateE" >
                        <span id="dateE_error"></span><br>

                  
                        <button type="submit" class="btn btn-primary btn-user btn-block" onClick="validerFormulaire()">Add experience</button> 
                        </form>
                      </div>
                    </div>
                </div>
